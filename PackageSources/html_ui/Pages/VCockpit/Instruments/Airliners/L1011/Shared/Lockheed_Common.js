...
(function (Lockheed) {
    ...
    Lockheed.ThrustModeDisplay = ThrustModeDisplay;
    class GearDisplay {
        constructor(_rootElement) {
            this.rootElement = null;
            this.currentValue = 0;
        ...
        refreshValue(_value, _force = false) {
            if ((_value != this.currentValue) || _force) {
                ...
                if (this.currentValue <= 0) {
                    this.timeout = Lockheed.GearDisplay.TIMEOUT_LENGTH;
                }
            }
        }
    }
    GearDisplay.TIMEOUT_LENGTH = 10000;
    Lockheed.GearDisplay = GearDisplay;
    class FlapsDisplay {
        ...
        refreshValue(_realFlapsAngle, _force = false) {
            if ((_realFlapsAngle != this.realFlapsAngle) || _force) {
                ...
                if (currentAngle <= 0) {
                    this.timeout = Lockheed.FlapsDisplay.TIMEOUT_LENGTH;
                }
            }
        }
    }
    FlapsDisplay.TIMEOUT_LENGTH = 3000;
    Lockheed.FlapsDisplay = FlapsDisplay;
    class StabDisplay {
    ...
    Lockheed.StabDisplay = StabDisplay;
    class RudderDisplay {
    ...
    Lockheed.RudderDisplay = RudderDisplay;
    ...
    Lockheed.FuelBaseComponent = FuelBaseComponent;
    ...
    Lockheed.FuelEngineState = FuelEngineState;
    ...
    Lockheed.FakeFuelLine = FakeFuelLine;
    ...
    Lockheed.InfoPanelsManager = InfoPanelsManager;
    class InfoPanel {
    ...
    Lockheed.InfoPanel = InfoPanel;
})(Lockheed || (Lockheed = {}));
//# sourceMappingURL=Lockheed_Common.js.map