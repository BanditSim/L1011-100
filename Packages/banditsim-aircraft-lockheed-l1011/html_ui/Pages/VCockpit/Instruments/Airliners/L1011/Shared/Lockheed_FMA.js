...
(function (Lockheed) {
    class FMA extends TemplateElement {
        ...
        get templateID() { return "LockheedFMATemplate"; }
        get aircraft() {
        ...
        init() {
            if (this.allAnnunciations != null) {
                this.allAnnunciations.push(new Lockheed_FMA.Column1Top(this, this.querySelector("#COL1_TOP"), this.querySelector("#COL1_TOP_HIGHLIGHT")));
                this.allAnnunciations.push(new Lockheed_FMA.Column2Top(this, this.querySelector("#COL2_TOP"), this.querySelector("#COL2_TOP_HIGHLIGHT")));
                this.allAnnunciations.push(new Lockheed_FMA.Column2Middle(this, this.querySelector("#COL2_MIDDLE"), null));
                this.allAnnunciations.push(new Lockheed_FMA.Column2Bottom(this, this.querySelector("#COL2_BOTTOM"), null, this.querySelector("#COL2_BOTTOM_ARROWS")));
                this.allAnnunciations.push(new Lockheed_FMA.Column3Top(this, this.querySelector("#COL3_TOP"), this.querySelector("#COL3_TOP_HIGHLIGHT")));
                this.allAnnunciations.push(new Lockheed_FMA.Column3Middle(this, this.querySelector("#COL3_MIDDLE"), null));
            }
        ...
        update(_deltaTime) {
            ...
            Lockheed_FMA.ApproachStatus.update(_deltaTime);
            if (this.allAnnunciations != null) {
...
(function (Lockheed_FMA) {
    ...
    Lockheed_FMA.ApproachStatus = ApproachStatus;
    class Annunciation {
        ...
        changeMode(_mode) {
            ...
            if (this.divElement != null)
                diffAndSetHTML(this.divElement, "<span>" + this.getCurrentModeText() + "</span>");
            this.setHighlightVisibility(this.currentMode >= 0);
        }
        setHighlightVisibility(_show) {
            if (this.highlightElement != null) {
                diffAndSetStyle(this.highlightElement, StyleProperty.display, _show ? "block" : "none");
                if (_show) {
    ...
    Lockheed_FMA.Annunciation = Annunciation;
    ...
    Lockheed_FMA.Column1Top = Column1Top;
    class Column2Top extends Annunciation {
        getActiveMode() {
            ...
            if (Simplane.getAutoPilotFlightDirectorActive(1) && Simplane.getAltitudeAboveGround() < 10) {
                return 8;
            }
            if (this.fma.aircraft == Aircraft.AS01B) {
            }
    ...
    Lockheed_FMA.Column2Top = Column2Top;
    class Column2Middle extends Annunciation {
        getActiveMode() {
            ...
            if (Simplane.getAPLNAVArmed() === 1 && Simplane.getAPLNAVActive() === 0) {
                return 2;
            }
    ...
    Lockheed_FMA.Column2Middle = Column2Middle;
    class Column2Bottom extends Annunciation {
        ...
        changeMode(_mode) {
            ...
            if (this.arrowsElement != null) {
                diffAndSetStyle(this.arrowsElement, StyleProperty.display, (_mode == 3) ? "block" : "none");
            }
        }
        getActiveMode() {
            if (Simplane.getAutoPilotActive()) {
    ...
    Lockheed_FMA.Column2Bottom = Column2Bottom;
    class Column3Top extends Annunciation {
        getActiveMode() {
            ...
            if (Simplane.getEngineThrottleMode(0) === ThrottleMode.HOLD && Simplane.getAPVNAVArmed() === 1) {
                return 6;
            }
            if (Simplane.getAPFLCHActive() === 1) {
                return 2;
            }
            if (Simplane.getAPAltHoldActive() === 1) {
                return 0;
            }
            if (ApproachStatus.isFlareActive) {
                return 1;
            }
            if (SimVar.GetSimVarValue("L:AP_VS_ACTIVE", "number") === 1) {
                if (this.fma.aircraft == Aircraft.B747_8) {
                    return 10;
                }
                else {
    ...
    Lockheed_FMA.Column3Top = Column3Top;
    class Column3Middle extends Annunciation {
        getActiveMode() {
            ...
            if (Simplane.getAPVNAVArmed() === 1 && Simplane.getAPVNAVActive() === 0) {
                return 3;
            }
    ...
    Lockheed_FMA.Column3Middle = Column3Middle;
})(Lockheed_FMA || (Lockheed_FMA = {}));
customElements.define("Lockheed-fma", Lockheed.FMA);
//# sourceMappingURL=Lockheed_FMA.js.map