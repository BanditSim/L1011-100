class Lockheed_FMC extends FMCMainDisplay {
    constructor() {
        super(...arguments);
    ...
    setLockheedDirectToOrInsert(waypointIdent, waypointIndex, callback = EmptyCallback.Boolean) {
        ...
        if (i != -1) {
            return this.setLockheedDirectTo(waypointIdent, waypointIndex, callback);
        }
        this.insertWaypoint(waypointIdent, waypointIndex, callback);
    }
    setLockheedDirectTo(directToWaypointIdent, directToWaypointIndex, callback = EmptyCallback.Boolean) {
        let waypoints = this.flightPlanManager.getWaypoints();
...
//# sourceMappingURL=Lockheed_FMC.js.map